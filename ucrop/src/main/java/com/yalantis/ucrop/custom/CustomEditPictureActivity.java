...
public class CustomEditPictureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ucrop_custom_activity);
        Log.e("dfdf", "onCreate: create custom picture" );
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mCompressQuality = intent.getIntExtra(UCrop.Options.EXTRA_COMPRESSION_QUALITY, CustomEditPictureActivity.DEFAULT_COMPRESS_QUALITY);
